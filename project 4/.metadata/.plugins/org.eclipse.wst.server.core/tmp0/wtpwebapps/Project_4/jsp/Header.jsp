...
<body>
	...
	<table style="font-size: 18px">
		<tr>
			...
			<td rowspan="2">
				<h1 align="right">
					<img src="<%=ORSView.APP_CONTEXT%>/img/RaysLogo.png" width="140" height="50">
				</h1>
			</td>
		</tr>
		...
		<tr>
			...
			<td colspan="2">
				...
				|
					...
					<%-- <a href ="<%=ORSView.ORDER_LIST_CTL%>">Order List</a> |
					<a href="<%=ORSView.ORDER_CTL%>">Add Order</a> | 
				...
				<a href="<%=ORSView.BANK_LIST_CTL%>">Bank List</a> | 
					 --%>
					 <a href="<%=ORSView.LESSION_CTL%>">Add Lession</a> | 
					<a href="<%=ORSView.LESSION_LIST_CTL%>">Lession list</a> |
						<a href="<%=ORSView.SCHOOL_CTL%>">Add School</a> | 
					<a href="<%=ORSView.SCHOOL_LIST_CTL%>">School List</a> |
						<a href="<%=ORSView.TOPIC_CTL%>">Add Topic</a> | 
					<a href="<%=ORSView.TOPIC_LIST_CTL%>">TopicList</a> |
