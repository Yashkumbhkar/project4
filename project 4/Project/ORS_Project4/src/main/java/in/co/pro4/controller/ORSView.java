...
public interface ORSView {
	...
	public String BANK_CTL_VIEW = PAGE_FOLDER + "/BankView.jsp";
	public String LESSION_VIEW = PAGE_FOLDER + "/LessionView.jsp";
	public String LESSION_LIST_VIEW = PAGE_FOLDER + "/LessionListView.jsp";
	public String SCHOOL_VIEW = PAGE_FOLDER + "/SchoolView.jsp";
	public String SCHOOL_LIST_VIEW = PAGE_FOLDER + "/SchoolListView.jsp";
	...
	public String SCHOOL_CTL = APP_CONTEXT + "/ctl/SchoolCtl";
	public String SCHOOL_LIST_CTL = APP_CONTEXT + "/ctl/SchoolListCtl";
