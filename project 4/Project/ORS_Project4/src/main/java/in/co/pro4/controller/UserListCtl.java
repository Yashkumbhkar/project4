...
public class UserListCtl extends BaseCtl {
	...
	protected void preload(HttpServletRequest request) {
		...
		/*
		 * UserModel model = new UserModel(); List model1 = null; try { List lmodel =
		 * model.list(0,0); request.setAttribute("UserModel", lmodel); } catch
